export const metadata = {
    ...
    coverImage: "/assets/blog/linear-support/speed-of-light.png",
    ...
    ogImage: {
        url: "/assets/blog/linear-support/speed-of-light.png",
    },
};

We were just weeks away from crucial meetings with VCs, and had just sunsetted our main product. Fun times to be in.

<img src="/assets/blog/linear-support/speed-of-light.png" alt="Troll physics - a car going at the speed of light propelled by a torchlight" className="w-full" />
...
<figure className="flex flex-col items-center">
    <img src="/assets/blog/linear-support/atlas.png" alt="Particular of the Farnese Atlas – 2nd-century CE Roman marble sculpture of Atlas holding up a celestial globe" className="w-full" />
...
<figure className="flex flex-col items-center">
    <img src="/assets/blog/linear-support/whiteboard.jpeg" alt="Some points we had on the whiteboard for our MVP: spawn an async task against your codebase, iterate on a PR, tool use for agents, time budget." className="w-full" />
    <figcaption className="pt-2 text-center font-semibold">
