      ...
      <div className="px-8 md:px-12 py-8 md:py-12 bg-noise bg-background border-t border-t-muted">
        <div className="max-w-screen-xl m-auto flex flex-col justify-center items-center">
          <p className="text-3xl text-center font-bold">
            Built on top of <a href="https://code.visualstudio.com" rel="noopener noreferrer" target="_blank">
          ...
          <p className="text-xl text-center">
            All your settings, keybindings and extensions will <span className="italic">just work!</span><br />
            Look for the &lsquo;Import Settings and keybindings from VSCode&rsquo; option in the settings.
          </p>
        </div>
      </div>
