    ...
    try {
        ...
        if (releases) {
            for (const release of releases) {
                ...
                // Windows - x64
                if (assetMap[`AideSetup-x64-${version}.exe`] && !downloads.Windows?.amd64?.systemInstaller) {
                ...
                if (assetMap[`AideUserSetup-x64-${version}.exe`] && !downloads.Windows?.amd64?.userInstaller) {
                ...
                // Windows - arm64
                if (assetMap[`AideSetup-arm64-${version}.exe`] && !downloads.Windows?.arm64?.systemInstaller) {
                ...
                if (assetMap[`AideUserSetup-arm64-${version}.exe`] && !downloads.Windows?.arm64?.userInstaller) {
