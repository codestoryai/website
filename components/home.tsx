                    ...
                    <div className="container px-4 md:px-6">
                        ...
                        <div className="mx-auto mt-16 max-w-[800px] text-center">
                            <p className="text-lg">
                                ...
                                probably were very impressed – <b>at first</b>.
                                The initial bliss quickly fades away when you
                                realise the code will be very hard to maintain,
                            ...
                            <div className="grid items-center gap-6 lg:grid-cols-2 lg:gap-12 xl:grid-cols-2">
                                <div className="space-y-4">
                                    ...
                                    <p className="mx-auto max-w-[700px] md:text-lg/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                                        Aide not only understands your codebase,
                                        but keeps track of previous editing
                                        sessions. It aligns more and more with
                                        your goals as you go along.{" "}
                                        <b>
                                            Effortlessly iterate, review and
                                            fill in possible gaps
                                        </b>
                                        , like you would while pair programming.
                                    </p>
                                    <blockquote className="pt-8 text-lg leading-snug lg:leading-normal xl:text-lg">
                                        &ldquo;Insanity is doing the same thing
                                        over and over again and expecting
                                        different results&rdquo; &mdash;
                                        Einstein probably never said that, but
                                        this quote rings true when guiding
                                        agents to make large-scale edits with
                                        today&apos;s tools.
                                    </blockquote>
                                    <div className="flex items-center space-x-4 2xl:-ml-14">
                                        ...
                                        />
                                        <div className="text-gray-500">
                                            Zi, Software Engineer @ CodeStory
                                        </div>
                                    </div>
                                </div>
                                <div className="relative">
                        ...
                        <div className="container px-4 md:px-6 2xl:px-12">
                            <div className="grid items-center gap-6 lg:grid-cols-2 lg:gap-12 xl:grid-cols-2">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <p className="mx-auto max-w-[700px] md:text-lg/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                                        Being in the editor not only keeps you
                                        in control, but gives Aide access to{" "}
                                        <b>the same tools developers use</b>.
                                        Our agents are aware of the side effects
                                        of their changes thanks to language
                                        features. We don&apos;t just wreak havoc
                                        on your code and leave you to clean up
                                        the mess.
                                    </p>
                                    <blockquote className="pt-8 text-lg leading-snug lg:leading-normal xl:text-lg">
                                        ...
                                        and (kinda shockingly) became the SOTA,
                                        resolving 43% of the issues.
                                    </blockquote>
                            ...
                            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                                <Card className="p-6">
                                    ...
                                    <p className="text-gray-500">
                                        Enforce and expose deep reasoning behind
                                        complex changes. Break down large tasks
                                        into smaller units of work that follow a
                                        logical flow.
                                    </p>
                                </Card>
                                <Card className="p-6">
                                    ...
                                    <p className="text-gray-500">
                                        With prompt caching and multi-location
                                        editing, you will be amazed by how
                                        little time occurs between pressing
                                        enter and reviewing the changes.
                                    </p>
                                </Card>
                                <Card className="p-6">
                                    <div className="mb-4 flex h-14 w-14 items-center justify-center rounded-lg bg-green-50">
                                    ...
                                    <p className="text-gray-500">
                                        ...
                                        changes made by both the developer and
                                        AI to keep a continuous context.
                                    </p>
                                </Card>
                                <Card className="p-6">
                                    ...
                                    <p className="text-gray-500">
                                        Aide gathers diagnostics from the whole
                                        codebase using Language Server APIs to
                                        quickly catch and propose fixes for
                                ...
                                <Card className="p-6">
                                    ...
                                    <p className="text-gray-500">
                                        Aide has native support for checkpoints
                                        and rollbacks to keep track of file
                                        versions across AI changes, while
                                        preserving the undo stack.
                                    </p>
                                </Card>
                                <Card className="p-6">
                                    <div className="mb-4 flex h-14 w-14 items-center justify-center rounded-lg bg-amber-50">
                                    ...
                                    <p className="text-gray-500">
                                        All requests and responses are stored on
                                        a SQLite DB on your machine. You can use
                                        them to fine-tune your models, which we
                                        optionally support.
                                    </p>
                                </Card>
                            </div>
                    ...
                    <div className="container px-4 md:px-6">
                        <div className="flex flex-col items-center justify-center space-y-4 text-center">
                            ...
                            <p className="max-w-[720px] text-gray-600 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                                We know we have a way to go, and we want to make
                                a product experienced developers will love.
                            </p>
                            <p className="max-w-[720px] text-gray-600 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                            ...
                            <div className="m-auto flex max-w-screen-xl flex-col items-center justify-center">
                                <p className="mt-16 text-center text-3xl font-extrabold">
                                    Downloads
                                </p>
                                <div className="my-8 grid w-full grid-cols-9 gap-8 md:text-lg">
                                    <div className="col-span-full flex flex-col items-center md:col-span-3">
