...
export default function Header({ logoSuffix }: HeaderProps) {
    ...
    return (
        <div className="absolute z-10 w-full">
            ...
            {isMenuOpen && (
                <div
                    className="fixed inset-0 z-[95] bg-black/90 md:hidden"
                    aria-hidden="true"
                />
            )}
            ...
            <div className="m-auto flex max-w-screen-2xl items-center justify-between p-8 text-2xl md:p-12">
                ...
                <div className="relative flex items-center space-x-6">
                    {/* Hamburger Button */}
                    <button
                        className="absolute right-8 z-[100] rounded-lg p-3 hover:bg-gray-800/50 md:hidden"
                    ...
                    <div
                        ref={menuRef}
                        className={`fixed right-0 top-0 z-[96] h-screen w-72 transform bg-black/95 p-8 pt-24 transition-transform duration-300 ease-in-out md:static md:block ${isMenuOpen ? "translate-x-0 shadow-lg" : "translate-x-full"} md:h-auto md:w-auto md:transform-none md:bg-transparent md:p-0 md:pt-0 md:shadow-none`}
                    >
